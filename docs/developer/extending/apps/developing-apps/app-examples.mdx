...
<!-- TODO describe how to start with Saleor App Template -->
...
- [dummy payment](https://github.com/saleor/dummy-payment-app)
- [metadata manager](apps-patterns/persistence-with-metadata-manager)
- [external webhooks](apps-patterns/handling-external-webhooks)
- [async webhook handler](https://github.com/saleor/app-examples/tree/main/examples)
- [dashboard extensions](https://github.com/saleor/app-examples/tree/main/examples)
- [protected route](https://github.com/saleor/app-examples/tree/main/examples)
- [tRPC](https://github.com/saleor/app-examples/tree/main/examples)
